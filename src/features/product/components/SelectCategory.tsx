    ...
    <div className="relative w-full space-y-3" ref={wrapperRef}>
      ...
      <div>
        ...
        <span className="text-xs text-slate-500 dark:text-slate-400">
          دسته‌بندی مورد نظر را جستجو یا از زیردسته‌ها انتخاب کنید.
        </span>
      </div>
      ...
      <div className="relative">
        <input
          ...
          className="w-full rounded-xl border border-slate-200 bg-slate-50/70 px-4 py-3 pl-10 text-sm 
                     text-slate-900 outline-none transition-all placeholder:text-slate-400 
                     ...
                     dark:placeholder:text-slate-500 dark:focus:border-teal-400 dark:focus:bg-slate-900 
                     dark:focus:ring-teal-400/10 shadow-xs"
        />
      ...
      {/* باکس انتخاب زیردسته‌ها (در صورت وجود فرزند) */}
      {children.length > 0 && (
